	...
	templateData:
		...
		site:
			...
			authors: [
						...
						{'nick': 'wendy', 'pic': 'Wendy.jpeg', 'name': 'Wendy Ly', 'email': 'wendy@magneticbear.com', 'github': '', 'twitter': 'lovewendyxo', 'title': 'Designer', 'tagline': 'Pretty things I see...','bio': 'Wendy is our pixel conjuror. Master of all that is pixelated beauty. She is not much of talker but her work totally speaks for itself.'}]
